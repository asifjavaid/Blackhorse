class UserMovementsResponseModel {
  final String? id;
  final String? userId;
  final String name;
  final String type;
  ...
  factory UserMovementsResponseModel.fromJson(Map<String, dynamic> json) {
    return UserMovementsResponseModel(
      id: json['id'],
      name: json['name'],
      type: json['type'] ?? '',
      userId: json['userId'] ?? '',
  ...
  UserMovementsResponseModel copyWith(
      {String? userId,
      String? name,
      String? ingredient,
      int? dosage,
