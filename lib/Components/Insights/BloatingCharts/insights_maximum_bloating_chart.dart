...
class InsightsMaximumBloatingChart extends StatefulWidget {
  final InsightsGraphModel data;

  const InsightsMaximumBloatingChart({super.key, required this.data});

  @override
  InsightsMaximumBloatingChartState createState() => InsightsMaximumBloatingChartState();
}

class InsightsMaximumBloatingChartState extends State<InsightsMaximumBloatingChart> {
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text('Maximum bloating levels', style: textTheme.headlineSmall),
              const Spacer(),
              // GestureDetector(
              //     onTap: () {
          ...
          Row(
            ...
            children: [
              Text('Maximum Bloating', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: SfCartesianChart(
        ...
        series: ChartHelper.getMaximumBloatingBarSeries(widget.data),
      ),
    );
  }
}
