...
class InsightsAverageBloatingChart extends StatefulWidget {
  final InsightsGraphModel data;
  const InsightsAverageBloatingChart({super.key, required this.data});

  @override
  InsightsAverageBloatingChartState createState() => InsightsAverageBloatingChartState();
}

class InsightsAverageBloatingChartState extends State<InsightsAverageBloatingChart> {
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [const PremiumIconWidget(), Text('Average bloating levels', style: textTheme.headlineSmall), const Spacer(), const InsightsExpandGraphWidget()],
          ),
          ...
          Row(
            ...
            children: [
              Text('Average Bloating', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: SfCartesianChart(
        ...
        series: ChartHelper.getAverageBloatingLineSeries(widget.data.graphData!),
      ),
    );
  }
}
