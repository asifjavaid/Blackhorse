...
class InsightsMaximumStressChart extends StatefulWidget {
  final InsightsGraphModel data;

  const InsightsMaximumStressChart({super.key, required this.data});

  @override
  InsightsMaximumStressChartState createState() => InsightsMaximumStressChartState();
}

class InsightsMaximumStressChartState extends State<InsightsMaximumStressChart> {
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text('Maximum stress levels', style: textTheme.headlineSmall),
              const Spacer(),
              // GestureDetector(
              //     onTap: () {
          ...
          Row(
            ...
            children: [
              Text('Maximum Stress', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: SfCartesianChart(
        ...
        series: ChartHelper.getMaximumStressBarSeries(widget.data),
      ),
    );
  }
}
