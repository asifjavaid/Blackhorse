...
class InsightsAverageStressChart extends StatefulWidget {
  final InsightsGraphModel data;
  const InsightsAverageStressChart({super.key, required this.data});

  @override
  InsightsAverageStressChartState createState() => InsightsAverageStressChartState();
}

class InsightsAverageStressChartState extends State<InsightsAverageStressChart> {
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [const PremiumIconWidget(), Text('Average stress levels', style: textTheme.headlineSmall), const Spacer(), const InsightsExpandGraphWidget()],
          ),
          ...
          Row(
            ...
            children: [
              Text('Average Stress', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: SfCartesianChart(
        ...
        series: ChartHelper.getAverageStressLineSeries(widget.data.graphData!),
      ),
    );
  }
}
