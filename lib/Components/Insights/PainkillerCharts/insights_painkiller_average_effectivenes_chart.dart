...
class InsightsPainkillerAverageEffectivenessChart extends StatefulWidget {
  final InsightsGraphModel data;
  const InsightsPainkillerAverageEffectivenessChart({super.key, required this.data});

  @override
  InsightsPainkillerAverageEffectivenessChartState createState() => InsightsPainkillerAverageEffectivenessChartState();
}

class InsightsPainkillerAverageEffectivenessChartState extends State<InsightsPainkillerAverageEffectivenessChart> {
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              Text(
                'Average effectiveness $timeFrame',
