...
class InsightsSelfcareCircles extends StatefulWidget {
  final InsightsSelfCareInCircleModel data;

  const InsightsSelfcareCircles({super.key, required this.data});

  @override
  InsightsSelfcareCirclesState createState() => InsightsSelfcareCirclesState();
}

class InsightsSelfcareCirclesState extends State<InsightsSelfcareCircles> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text('Self-care in circles', style: textTheme.headlineSmall),
          const SizedBox(height: 24),
          SelfcareCirclesGrid(trackingData: widget.data.trackingData!),
          const SizedBox(height: 24),
          Row(
...
class SelfcareCirclesGrid extends StatelessWidget {
  final Map<String, List<SelfcareInCircleModel>> trackingData;

  const SelfcareCirclesGrid({super.key, required this.trackingData});
