...
class InsightsSelfcareAverageEnjoymentChart extends StatefulWidget {
  final InsightsGraphModel data;
  const InsightsSelfcareAverageEnjoymentChart({super.key, required this.data});

  @override
  InsightsSelfcareAverageEnjoymentChartState createState() => InsightsSelfcareAverageEnjoymentChartState();
}

class InsightsSelfcareAverageEnjoymentChartState extends State<InsightsSelfcareAverageEnjoymentChart> {
  @override
  void initState() {
    super.initState();
  }
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Text('Average enjoyment', style: textTheme.headlineSmall),
              const Spacer(),
              InsightsExpandGraphWidget(onTap: () {
          ...
          Row(
            ...
            children: [
              Text('Average enjoyment over $timeFrame', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: SfCartesianChart(
        ...
        series: ChartHelper.getAveragePainLineSeries(widget.data.graphData!),
      ),
    );
  }
}
