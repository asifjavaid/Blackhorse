...
class InsightsMaximumMoodChart extends StatefulWidget {
  final InsightsGraphModel data;

  const InsightsMaximumMoodChart({super.key, required this.data});

  @override
  InsightsMaximumMoodChartState createState() => InsightsMaximumMoodChartState();
}

class InsightsMaximumMoodChartState extends State<InsightsMaximumMoodChart> {
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text('Maximum mood levels', style: textTheme.headlineSmall),
              const Spacer(),
              // GestureDetector(
              //     onTap: () {
          ...
          Row(
            ...
            children: [
              Text('Maximum Mood', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: SfCartesianChart(
        ...
        series: ChartHelper.getMaximumMoodBarSeries(widget.data),
      ),
    );
  }
}
