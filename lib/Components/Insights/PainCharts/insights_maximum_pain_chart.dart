...
class InsightsMaximumPainChart extends StatefulWidget {
  final InsightsGraphModel data;

  const InsightsMaximumPainChart({super.key, required this.data});

  @override
  InsightsMaximumPainChartState createState() => InsightsMaximumPainChartState();
}

class InsightsMaximumPainChartState extends State<InsightsMaximumPainChart> {
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text('Maximum pain levels', style: textTheme.headlineSmall),
              const Spacer(),
              // GestureDetector(
              //     onTap: () {
          ...
          Row(
            ...
            children: [
              Text('Maximum Pain', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: SfCartesianChart(
        ...
        series: ChartHelper.getMaximumPainBarSeries(widget.data),
      ),
    );
  }
}
