...
class InsightsAveragePainChart extends StatefulWidget {
  final InsightsGraphModel data;
  const InsightsAveragePainChart({super.key, required this.data});

  @override
  InsightsAveragePainChartState createState() => InsightsAveragePainChartState();
}

class InsightsAveragePainChartState extends State<InsightsAveragePainChart> {
  @override
  void initState() {
    super.initState();
  }
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [const PremiumIconWidget(), Text('Average pain levels', style: textTheme.headlineSmall), const Spacer(), const InsightsExpandGraphWidget()],
          ),
          ...
          Row(
            ...
            children: [
              Text('Average Pain', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
