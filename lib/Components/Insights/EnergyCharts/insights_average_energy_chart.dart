...
class InsightsAverageEnergyChart extends StatefulWidget {
  final InsightsGraphModel data;
  const InsightsAverageEnergyChart({super.key, required this.data});

  @override
  InsightsAverageEnergyChartState createState() => InsightsAverageEnergyChartState();
}

class InsightsAverageEnergyChartState extends State<InsightsAverageEnergyChart> {
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [const PremiumIconWidget(), Text('Average energy levels', style: textTheme.headlineSmall), const Spacer(), const InsightsExpandGraphWidget()],
          ),
          ...
          Row(
            ...
            children: [
              Text('Average Energy', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: SfCartesianChart(
        ...
        series: ChartHelper.getAverageEnergyLineSeries(widget.data.graphData!),
      ),
    );
  }
}
