...
class InsightsMaximumEnergyChart extends StatefulWidget {
  final InsightsGraphModel data;

  const InsightsMaximumEnergyChart({super.key, required this.data});

  @override
  InsightsMaximumEnergyChartState createState() => InsightsMaximumEnergyChartState();
}

class InsightsMaximumEnergyChartState extends State<InsightsMaximumEnergyChart> {
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text('Maximum energy levels', style: textTheme.headlineSmall),
              const Spacer(),
              // GestureDetector(
              //     onTap: () {
          ...
          Row(
            ...
            children: [
              Text('Maximum Energy', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: SfCartesianChart(
        ...
        series: ChartHelper.getMaximumEnergyBarSeries(widget.data),
      ),
    );
  }
}
