...
class InsightsAverageFatigueChart extends StatefulWidget {
  final InsightsGraphModel data;
  const InsightsAverageFatigueChart({super.key, required this.data});

  @override
  InsightsAverageFatigueChartState createState() => InsightsAverageFatigueChartState();
}

class InsightsAverageFatigueChartState extends State<InsightsAverageFatigueChart> {
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [const PremiumIconWidget(), Text('Average fatigue levels', style: textTheme.headlineSmall), const Spacer(), const InsightsExpandGraphWidget()],
          ),
          ...
          Row(
            ...
            children: [
              Text('Average Fatigue', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: SfCartesianChart(
        ...
        series: ChartHelper.getAverageFatigueLineSeries(widget.data.graphData!),
      ),
    );
  }
}
