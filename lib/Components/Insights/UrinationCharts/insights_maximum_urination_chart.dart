...
class InsightsMaximumUrinationsChart extends StatefulWidget {
  final InsightsGraphModel data;

  const InsightsMaximumUrinationsChart({super.key, required this.data});

  @override
  InsightsMaximumUrinationsChartState createState() => InsightsMaximumUrinationsChartState();
}

class InsightsMaximumUrinationsChartState extends State<InsightsMaximumUrinationsChart> {
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              Text('Maximum Urination', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
