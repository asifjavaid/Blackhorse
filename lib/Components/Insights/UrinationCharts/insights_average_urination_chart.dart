...
class InsightsAverageUrinationsChart extends StatefulWidget {
  final InsightsGraphModel data;
  const InsightsAverageUrinationsChart({super.key, required this.data});

  @override
  InsightsAverageUrinationsChartState createState() => InsightsAverageUrinationsChartState();
}

class InsightsAverageUrinationsChartState extends State<InsightsAverageUrinationsChart> {
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text('Average urgency', style: textTheme.headlineSmall),
              const Spacer(),
          ...
          Row(
            ...
            children: [
              Text('Average urgency', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
