...
class InsightsBowelMovementCircles extends StatefulWidget {
  final InsightsBowelMovementCircleModel data;

  const InsightsBowelMovementCircles({super.key, required this.data});

  @override
  InsightsBowelMovementCirclesState createState() => InsightsBowelMovementCirclesState();
}

class InsightsBowelMovementCirclesState extends State<InsightsBowelMovementCircles> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text('Bowel movements in circles', style: textTheme.headlineSmall),
          const SizedBox(height: 24),
          BowelMovementCirclesGrid(trackingData: widget.data.trackingData!),
          const SizedBox(height: 24),
          Row(
...
class BowelMovementCirclesGrid extends StatelessWidget {
  final Map<String, List<BowelMovementCircle>> trackingData;

  const BowelMovementCirclesGrid({super.key, required this.trackingData});
