...
class InsightsAverageBowelMovementsChart extends StatefulWidget {
  final InsightsGraphModel data;
  const InsightsAverageBowelMovementsChart({super.key, required this.data});

  @override
  InsightsAverageBowelMovementsChartState createState() => InsightsAverageBowelMovementsChartState();
}

class InsightsAverageBowelMovementsChartState extends State<InsightsAverageBowelMovementsChart> {
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [const PremiumIconWidget(), Text('Average consistency', style: textTheme.headlineSmall), const Spacer(), const InsightsExpandGraphWidget()],
          ),
          ...
          Row(
            ...
            children: [
              Text('Average consistency', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: SfCartesianChart(
        ...
        series: ChartHelper.getAverageBowelMovementsLineSeries(widget.data.graphData!),
      ),
    );
  }
}
