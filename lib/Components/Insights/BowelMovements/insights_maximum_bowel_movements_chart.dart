...
class InsightsMaximumBowelMovementsChart extends StatefulWidget {
  final InsightsGraphModel data;

  const InsightsMaximumBowelMovementsChart({super.key, required this.data});

  @override
  InsightsMaximumBowelMovementsChartState createState() => InsightsMaximumBowelMovementsChartState();
}

class InsightsMaximumBowelMovementsChartState extends State<InsightsMaximumBowelMovementsChart> {
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text('Maximum Bowel Movements levels', style: textTheme.headlineSmall),
              const Spacer(),
              // GestureDetector(
              //     onTap: () {
          ...
          Row(
            ...
            children: [
              Text('Maximum Bowel Movements', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: SfCartesianChart(
        ...
        series: ChartHelper.getMaximumBowelMovementsBarSeries(widget.data),
      ),
    );
  }
}
