...
class InsightsAverageBleedingChart extends StatefulWidget {
  final InsightsGraphModel data;
  const InsightsAverageBleedingChart({super.key, required this.data});

  @override
  InsightsAverageBleedingChartState createState() => InsightsAverageBleedingChartState();
}

class InsightsAverageBleedingChartState extends State<InsightsAverageBleedingChart> {
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text('Average Bleeding', style: textTheme.headlineSmall),
              const Spacer(),
              const InsightsExpandGraphWidget(),
            ],
          ),
          ...
          Row(
            ...
            children: [
              Text('Average Bleeding', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
        ...
        primaryYAxis: NumericAxis(
          ...
          axisLabelFormatter: (args) {
            switch (args.value.toInt()) {
              case 2:
                return ChartAxisLabel("Spotting    ", const TextStyle(fontSize: 8, overflow: TextOverflow.visible));
              case 3:
                return ChartAxisLabel("Light          ", const TextStyle(fontSize: 8, overflow: TextOverflow.visible));
              case 4:
                return ChartAxisLabel("Moderate", const TextStyle(fontSize: 8, overflow: TextOverflow.visible));
              case 5:
                return ChartAxisLabel("Heavy        ", const TextStyle(fontSize: 8, overflow: TextOverflow.visible));
              case 6:
                return ChartAxisLabel("Super       \nheavy", const TextStyle(fontSize: 8, overflow: TextOverflow.visible));
              default:
                return ChartAxisLabel("Spotting    ", const TextStyle(fontSize: 8, overflow: TextOverflow.visible));
            }
          },
        ),
        series: ChartHelper.getBleedingIntensitySeries(widget.data.graphData!),
      ),
    );
  }
}
