...
class InsightsPadsChart extends StatefulWidget {
  final InsightsGraphModel data;

  const InsightsPadsChart({super.key, required this.data});

  @override
  InsightsPadsChartState createState() => InsightsPadsChartState();
}

class InsightsPadsChartState extends State<InsightsPadsChart> {
      ...
      child: Column(
        children: [
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text('Pads used', style: textTheme.headlineSmall),
                      ],
                    ),
                    const SizedBox(
                      height: 4,
                    ),
                    Text('Total amount of pads & tampons used', style: textTheme.bodySmall!.copyWith(color: AppColors.neutralColor500)),
                  ],
                ),
              ),
            ],
          ...
          Row(
            ...
            children: [
              Text('Average Pads Used', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
