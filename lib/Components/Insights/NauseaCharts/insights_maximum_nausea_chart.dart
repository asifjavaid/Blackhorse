...
class InsightsMaximumNauseaChart extends StatefulWidget {
  final InsightsGraphModel data;

  const InsightsMaximumNauseaChart({super.key, required this.data});

  @override
  InsightsMaximumNauseaChartState createState() => InsightsMaximumNauseaChartState();
}

class InsightsMaximumNauseaChartState extends State<InsightsMaximumNauseaChart> {
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text('Maximum nausea levels', style: textTheme.headlineSmall),
              const Spacer(),
              // GestureDetector(
              //     onTap: () {
          ...
          Row(
            ...
            children: [
              Text('Maximum Nausea', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: SfCartesianChart(
        ...
        series: ChartHelper.getMaximumNauseaBarSeries(widget.data),
      ),
    );
  }
}
