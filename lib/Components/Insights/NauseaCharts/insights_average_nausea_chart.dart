...
class InsightsAverageNauseaChart extends StatefulWidget {
  final InsightsGraphModel data;
  const InsightsAverageNauseaChart({super.key, required this.data});

  @override
  InsightsAverageNauseaChartState createState() => InsightsAverageNauseaChartState();
}

class InsightsAverageNauseaChartState extends State<InsightsAverageNauseaChart> {
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [const PremiumIconWidget(), Text('Average nausea levels', style: textTheme.headlineSmall), const Spacer(), const InsightsExpandGraphWidget()],
          ),
          ...
          Row(
            ...
            children: [
              Text('Average Nausea', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: SfCartesianChart(
        ...
        series: ChartHelper.getAverageNauseaLineSeries(widget.data.graphData!),
      ),
    );
  }
}
