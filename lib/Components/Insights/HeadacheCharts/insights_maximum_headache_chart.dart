...
class InsightsMaximumHeadacheChart extends StatefulWidget {
  final InsightsGraphModel data;

  const InsightsMaximumHeadacheChart({super.key, required this.data});

  @override
  InsightsMaximumHeadacheChartState createState() =>
      InsightsMaximumHeadacheChartState();
}

class InsightsMaximumHeadacheChartState
    extends State<InsightsMaximumHeadacheChart> {
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text('Maximum headache Intensity',
          ...
          Text(
            'Your highest pain levels over time',
          ...
          Row(
            ...
            children: [
              Text('Maximum intensity over $timeFrame',
