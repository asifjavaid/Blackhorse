...
class InsightsAverageHeadacheChart extends StatefulWidget {
  final InsightsGraphModel data;
  const InsightsAverageHeadacheChart({super.key, required this.data});

  @override
  InsightsAverageHeadacheChartState createState() =>
      InsightsAverageHeadacheChartState();
}

class InsightsAverageHeadacheChartState
    extends State<InsightsAverageHeadacheChart> {
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text('Average headache Intensity',
          ...
          Text(
            'Your average pain levels over time',
          ...
          Row(
            ...
            children: [
              Text('Average intensity over $timeFrame',
      ...
      child: SfCartesianChart(
        ...
        primaryXAxis: isDailyInterval
            ? DateTimeAxis(
                ...
                intervalType: isDailyInterval
                    ? DateTimeIntervalType.days
                    : DateTimeIntervalType.months,
                dateFormat:
                    isDailyInterval ? DateFormat.d() : DateFormat('MMM'),
            ...
            : CategoryAxis(
                ...
                axisLabelFormatter: (axisLabelRenderArgs) =>
                    ChartHelper.axisLabelFormatter(axisLabelRenderArgs,
                        isDailyInterval, firstDatesOfMonth),
                majorGridLines: const MajorGridLines(width: 0),
                labelStyle: textTheme.labelSmall!
                    .copyWith(color: AppColors.neutralColor400, fontSize: 8)),
        ...
        series:
            ChartHelper.getAverageHeadacheLineSeries(widget.data.graphData!),
      ),
    );
  }
}
