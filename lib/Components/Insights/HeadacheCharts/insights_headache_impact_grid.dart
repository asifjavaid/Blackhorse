...
class InsightsHeadacheImpactGrid extends StatefulWidget {
  final HeadacheTagList data;
  const InsightsHeadacheImpactGrid({super.key, required this.data});

  @override
  State<InsightsHeadacheImpactGrid> createState() =>
      _InsightsHeadacheImpactGridState();
}

class _InsightsHeadacheImpactGridState
    extends State<InsightsHeadacheImpactGrid> {
  String title = 'Effect on your quality of life';
  String subtitle =
      'This overview shows how often your headache has impacted your life in the following categories:';
  String description =
  ...
  List<Map<String, String>> helpText = [
    {
      "title": "Work: ",
      "desc": "The effect of headaches on your job or daily work activities."
    },
    {
      "title": "Social life: ",
      "desc":
          "How headaches influences your interactions and social activities."
    },
    {
      "title": "Sleep: ",
      "desc": "The impact of headaches on your sleep quality."
    },
    {
      "title": "Quality of life: ",
      "desc": "The overall effect of headaches on your daily well-being."
    },
  ];
