...
class InsightsMovementCircles extends StatefulWidget {
  final InsightsMovementCircleModel data;

  const InsightsMovementCircles({super.key, required this.data});

  @override
  InsightsMovementCirclesState createState() => InsightsMovementCirclesState();
}

class InsightsMovementCirclesState extends State<InsightsMovementCircles> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text('Movements in circles', style: textTheme.headlineSmall),
          const SizedBox(height: 24),
          MovementCirclesGrid(trackingData: widget.data.trackingData!),
          const SizedBox(height: 24),
          Row(
...
class MovementCirclesGrid extends StatelessWidget {
  final Map<String, List<MovementCircle>> trackingData;

  const MovementCirclesGrid({super.key, required this.trackingData});
