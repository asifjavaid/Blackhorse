...
class InsightsAverageIntensityChart extends StatefulWidget {
  final InsightsGraphModel data;
  const InsightsAverageIntensityChart({super.key, required this.data});

  @override
  InsightsAverageIntensityChartState createState() => InsightsAverageIntensityChartState();
}

class InsightsAverageIntensityChartState extends State<InsightsAverageIntensityChart> {
  @override
  void initState() {
    super.initState();
  }
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Text('Average intensity', style: textTheme.headlineSmall),
              const Spacer(),
          ...
          Row(
            ...
            children: [
              Text('Average intensity over $timeFrame', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
