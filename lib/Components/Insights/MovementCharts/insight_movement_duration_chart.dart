...
class InsightsMovementDurationChart extends StatefulWidget {
  final InsightsGraphModel data;

  const InsightsMovementDurationChart({super.key, required this.data});

  @override
  InsightsMovementDurationChartState createState() => InsightsMovementDurationChartState();
}

class InsightsMovementDurationChartState extends State<InsightsMovementDurationChart> {
  ...
  String getPracticeLabel(TimeFrameSelection selectionType) {
    switch (selectionType) {
      case TimeFrameSelection.oneMonth:
        return 'How many minutes you practiced per day';
      case TimeFrameSelection.threeMonths:
        return 'How many hours you practiced per week';
      case TimeFrameSelection.oneYear:
      default:
        return 'How many hours you practiced per month';
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text('Movement duration', style: textTheme.headlineSmall),
          const SizedBox(height: 9),
          Text(
            getPracticeLabel(provider.selectionType),
          ...
          Row(
            ...
            children: [
              Text('Average duration', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: SfCartesianChart(
        ...
        series: ChartHelper.getMovementDurationBarSeries(widget.data),
      ),
    );
  }
}
