...
class InsightsAverageEnjoymentChart extends StatefulWidget {
  final InsightsGraphModel data;
  const InsightsAverageEnjoymentChart({super.key, required this.data});

  @override
  InsightsAverageEnjoymentChartState createState() => InsightsAverageEnjoymentChartState();
}

class InsightsAverageEnjoymentChartState extends State<InsightsAverageEnjoymentChart> {
  @override
  void initState() {
    super.initState();
  }
