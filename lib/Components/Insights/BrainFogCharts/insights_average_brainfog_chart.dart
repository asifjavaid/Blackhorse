...
class InsightsAverageBrainFogChart extends StatefulWidget {
  final InsightsGraphModel data;
  const InsightsAverageBrainFogChart({super.key, required this.data});

  @override
  InsightsAverageBrainFogChartState createState() => InsightsAverageBrainFogChartState();
}

class InsightsAverageBrainFogChartState extends State<InsightsAverageBrainFogChart> {
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [const PremiumIconWidget(), Text('Average brain fog levels', style: textTheme.headlineSmall), const Spacer(), const InsightsExpandGraphWidget()],
          ),
          ...
          Row(
            ...
            children: [
              Text('Average Brain fog', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: SfCartesianChart(
        ...
        series: ChartHelper.getAverageBrainFogLineSeries(widget.data.graphData!),
      ),
    );
  }
}
