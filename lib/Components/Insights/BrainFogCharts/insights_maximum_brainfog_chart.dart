...
class InsightsMaximumBrainFogChart extends StatefulWidget {
  final InsightsGraphModel data;

  const InsightsMaximumBrainFogChart({super.key, required this.data});

  @override
  InsightsMaximumBrainFogChartState createState() => InsightsMaximumBrainFogChartState();
}

class InsightsMaximumBrainFogChartState extends State<InsightsMaximumBrainFogChart> {
        ...
        children: [
          Row(
            ...
            children: [
              ...
              Text('Maximum brain fog levels', style: textTheme.headlineSmall),
              const Spacer(),
              // GestureDetector(
              //     onTap: () {
          ...
          Row(
            ...
            children: [
              Text('Maximum Brain fog', style: textTheme.labelSmall!.copyWith(color: AppColors.neutralColor500)),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: SfCartesianChart(
        ...
        series: ChartHelper.getMaximumBrainFogBarSeries(widget.data),
      ),
    );
  }
}
