import 'package:ekvi/Components/Movements/movement_practice_option_chip.dart';
...
class MyPractices extends StatelessWidget {
  const MyPractices({super.key});

  @override
  Widget build(BuildContext context) {
    final vaultProvider = Provider.of<MovementVaultProvider>(context);
      ...
      child: Column(
        ...
        children: [
          ...
          if (allPractices.isEmpty)
            Text(
              "You haven't added any movements yet. Add one by clicking the + icon.",
            ...
            Text(
              "You haven't marked any movements as active. Review them by clicking the edit icon.",
              style: textTheme.titleSmall!.copyWith(
                color: AppColors.neutralColor500,
                fontStyle: FontStyle.italic,
              ),
            ...
            Wrap(
              ...
              children: currentPractices
                  .map((practice) => MovementPracticeOptionChip(
                        practice: practice,
                      ))
                  .toList(),
            ),
