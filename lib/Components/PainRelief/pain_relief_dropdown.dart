...
class PainReliefDropdown<T> extends StatefulWidget {
  ...
  @override
  State<PainReliefDropdown<T>> createState() => _PainReliefDropdownState<T>();
}

class _PainReliefDropdownState<T> extends State<PainReliefDropdown<T>> {
