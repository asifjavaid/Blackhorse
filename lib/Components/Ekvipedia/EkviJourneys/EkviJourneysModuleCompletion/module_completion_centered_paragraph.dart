...
class ModuleCompletionParagraph extends StatelessWidget {
  final List content;
  final Includes? assets;

  const ModuleCompletionParagraph(
  ...
  List<InlineSpan> _parseContent(
      List content, TextTheme textTheme, Includes? assets) {
  ...
  List<InlineSpan> _parseNestedContent(
      List content, TextTheme textTheme, Includes? assets) {
    return content.map<InlineSpan>((e) {
      final String nodeType = e['nodeType'];
            ...
            child: Transform.translate(
              ...
              child: Text(
                ...
                style: style?.copyWith(
                  fontSize:
                      style.fontSize != null ? style.fontSize! * 0.7 : null,
                ),
                textAlign: TextAlign.center,
              ),
            ),
