...
class SelfcareDropdown<T> extends StatefulWidget {
  ...
  @override
  State<SelfcareDropdown<T>> createState() => _StyledDropdownState<T>();
}

class _StyledDropdownState<T> extends State<SelfcareDropdown<T>> {
