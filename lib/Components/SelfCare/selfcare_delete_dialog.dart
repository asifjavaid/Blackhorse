...
class SelfcareDeleteAlertDialog extends StatelessWidget {
  final String title;
  final String subtitle;
  final String buttionTitle;
  final Function onPress;
  const SelfcareDeleteAlertDialog({super.key, required this.title, required this.subtitle, required this.buttionTitle, required this.onPress});
