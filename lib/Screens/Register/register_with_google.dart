...
class RegisterWithGoogle extends StatefulWidget {
  ...
  @override
  RegisterWithGoogleState createState() => RegisterWithGoogleState();
}

class RegisterWithGoogleState extends State<RegisterWithGoogle> {
                          ...
                          CustomButton(
                            ...
                            onPressed: () {
                              if (_formKey.currentState!.validate()) {
                                GoogleSignInHelper.continueWithGoogle();
                              }
                            },
                          ),
                          SizedBox(
