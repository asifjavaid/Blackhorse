      ...
      children: [
        ...
        Column(
          children: List.generate(items.length, (index) {
            ...
            final name = item.fields["authorName"] as String?;
            final bio = item.fields["authorBio"] as String?;
            final profilePicture = EkvipediaContentEntries.getAssetById(
...
class SpeakerHelperSheet extends StatelessWidget {
  final TextTheme textTheme;
  final Map<String, dynamic>? fields;
  final Includes? assets;

  const SpeakerHelperSheet({
    super.key,
    required this.textTheme,
