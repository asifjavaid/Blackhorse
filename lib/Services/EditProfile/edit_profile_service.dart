...
class EditProfileService {
  static Future<Either<dynamic, UserProfileModel>> fetchUserProfileFromApi(String userId) async {
    return await ApiManager.safeApiCall(() async {
      var response = await ApiBaseHelper.httpGetRequest(
        "${ApiLinks.getUser}/$userId",
      );
  ...
  static Future<Either<String, UserProfileModel>> updateUserProfileFromApi(UserProfileModel data, String userId) async {
    try {
