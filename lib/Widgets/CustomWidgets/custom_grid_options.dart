...
class GridOptions extends StatefulWidget {
  ...
  double height;
  double width;
  GridOptions? subCategoryOptions;
  EdgeInsets? margin;
  EdgeInsets? padding;
  bool? enableHelp;
  ...
  @override
  GridOptionsState createState() => GridOptionsState();
}

class GridOptionsState extends State<GridOptions> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              widget.subCategoryOptions ?? const SizedBox.shrink()
            ],
          ),
        ),
      ),
